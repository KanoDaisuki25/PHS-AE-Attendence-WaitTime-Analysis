...
* 
**Rigorous Validation**: Implemented basis dimension () checking and residual diagnostics (Q-Q plots, histograms) to ensure model stability and prevent overfitting.
...
1. 
**Cyclic Cubic Splines**: To capture 12-month seasonal periodic patterns.


2. 
**Autoregressive Terms**: Lagged variables to account for historical impact on future values.


3. 
**Binary Indicators**: Specifically addressing the anomalous shifts during the COVID-19 period.
...
| Metric | Adjusted  | Deviance Explained |
| --- | --- | --- |
| **Total Attendances** | 0.897 
